...
import {
  ...
  PaperLedgerDecisionInput,
  PaperLedgerRecord,
  PaperLedgerResult,
  PaperLedgerState
} from './PaperLedgerContracts';

export interface PaperLedgerEngineOptions {
...
export class PaperLedgerEngine {
  ...
  public constructor(
    private readonly repository: IPaperLedgerRepository,
    options: PaperLedgerEngineOptions
  ) {
  ...
  public async recordDecision(input: PaperLedgerDecisionInput): Promise<PaperLedgerResult> {
    ...
    if (this.seenEventIds.has(eventId)) {
      const duplicateRecord = this.buildRecord(
        input,
        eventId,
        this.runningBalance,
        this.peakBalance,
  ...
  public getState(): PaperLedgerState {
    return {
  ...
  private buildRecord(
    input: PaperLedgerDecisionInput,
    eventId: string,
  ...
  private createEventId(input: PaperLedgerDecisionInput): string {
  ...
  private validateInput(input: PaperLedgerDecisionInput): string | null {
