...
exports.RuntimeDrawdownMonitor = void 0;
const DrawdownPolicy_1 = require("./DrawdownPolicy");
class RuntimeDrawdownMonitor {
    constructor(policy) {
        this.policy = policy;
        this.head = 0;
        this.count = 0;
     ...
     */
    processRound(roundId, currentBankroll) {
        ...
        if (this.count < 2) {
            return { success: true, status: DrawdownPolicy_1.DrawdownStatus.HEALTHY };
        }
        ...
        if (currentDrawdown >= this.policy.maxLossPerWindow) {
            return { success: true, status: DrawdownPolicy_1.DrawdownStatus.VELOCITY_ALERT };
        }
        return { success: true, status: DrawdownPolicy_1.DrawdownStatus.HEALTHY };
    }
    reset() {
...
exports.RuntimeDrawdownMonitor = RuntimeDrawdownMonitor;
