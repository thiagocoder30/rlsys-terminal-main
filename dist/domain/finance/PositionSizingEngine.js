...
class PositionSizingEngine {
     ...
     */
    static calculateUnits(expectedEV, confidence, consecutiveLosses) {
        if (expectedEV <= 0)
            return 0;
        ...
        if (finalUnits < this.MIN_UNITS)
            return this.MIN_UNITS;
        if (finalUnits > this.MAX_UNITS)
            return this.MAX_UNITS;
        return finalUnits;
    }
}
exports.PositionSizingEngine = PositionSizingEngine;
PositionSizingEngine.MAX_UNITS = 5;
PositionSizingEngine.MIN_UNITS = 1;
