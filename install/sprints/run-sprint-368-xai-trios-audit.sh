...
echo "======================================"
echo " RL.SYS CORE - SPRINT 368"
echo " XAI TRIOS AUDIT & BEHAVIORAL COOLDOWN"
echo "======================================"

ROOT_DIR=$(git rev-parse --show-toplevel 2>/dev/null || pwd)
cd "$ROOT_DIR"

echo "[1/1] Reconstruindo Orquestrador com Painel de Auditoria (XAI)..."
...
git commit -m "fix(ux): add force-observe mechanism after manual trade rejection and introduce 'trios' XAI audit command (Sprint 368)" > /dev/null

echo "======================================"
echo -e "\033[1;32m SPRINT 368 INSTALADA COM SUCESSO \033[0m"
echo " STATUS: AUDITORIA XAI & COOLDOWN COMPORTAMENTAL ONLINE"
echo "======================================"
