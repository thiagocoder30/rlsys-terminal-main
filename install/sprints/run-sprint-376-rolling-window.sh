...
echo "======================================"
echo " RL.SYS CORE - SPRINT 376"
echo " OPERATIONAL ROLLING WINDOW ENGINE"
echo "======================================"

ROOT_DIR=$(git rev-parse --show-toplevel 2>/dev/null || pwd)
cd "$ROOT_DIR"

echo "[1/2] Reconfigurando Orquestrador para isolar a Janela Móvel de Tomada de Decisão..."
...
echo "[2/2] Sincronizando e gravando alterações estruturais..."
git add src/presentation/cli/LivePaperOrchestrator.ts
git commit -m "feat(risk): restrict signaling and VIX calculation to a rolling window of 90 spins to decouple micro-structure execution from long-term statistics (Sprint 376)" > /dev/null

echo "======================================"
echo -e "\033[1;32m SPRINT 376 HOMOLOGADA COM SUCESSO \033[0m"
echo " STATUS: ISOLAMENTO DE JANELA MÓVEL ATIVO"
echo "======================================"
