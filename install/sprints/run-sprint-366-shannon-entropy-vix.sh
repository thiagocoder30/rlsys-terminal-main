...
echo "======================================"
echo " RL.SYS CORE - SPRINT 366"
echo " SHANNON ENTROPY & TOXIC TABLE LOCK"
echo "======================================"

ROOT_DIR=$(git rev-parse --show-toplevel 2>/dev/null || pwd)
cd "$ROOT_DIR"

echo "[1/1] Injetando Entropia de Shannon e VIX no Orquestrador..."
...
git commit -m "feat(risk): implement Shannon Entropy to calculate live table VIX and trigger automated Toxic Table Lock during chaotic warmups (Sprint 366)" > /dev/null

echo "======================================"
echo -e "\033[1;32m SPRINT 366 INSTALADA COM SUCESSO \033[0m"
echo " STATUS: ESCUDO DE ENTROPIA ONLINE"
echo "======================================"
