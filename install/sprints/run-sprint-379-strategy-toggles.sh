...
echo "======================================"
echo " RL.SYS CORE - SPRINT 379"
echo " STRATEGY TOGGLING (MANUAL OVERRIDE)"
echo "======================================"

ROOT_DIR=$(git rev-parse --show-toplevel 2>/dev/null || pwd)
cd "$ROOT_DIR"

echo "[1/2] Injetando Roteamento Manual de Algoritmos no Orquestrador..."
...
echo "[2/2] Atualizando o Git com o suporte a Roteamento Manual (Toggles)..."
git add src/presentation/cli/LivePaperOrchestrator.ts
git commit -m "feat(cli): add 'disable' and 'enable' commands to allow users to manually toggle algorithms based on bankroll constraints (Sprint 379)" > /dev/null

echo "======================================"
echo -e "\033[1;32m SPRINT 379 INSTALADA COM SUCESSO \033[0m"
echo " STATUS: ROTEAMENTO MANUAL DE SINAIS ATIVO"
echo "======================================"
