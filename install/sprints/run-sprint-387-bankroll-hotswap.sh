...
export class LivePaperOrchestrator {
    ...
    private attachEventListeners(): void {
        this.rl.on('line', (line) => {
            ...
            // ==========================================
            // FIX SPRINT 387: TRUE HOT-SWAP (Sem wipe da mesa)
            // ==========================================
            if (cmd.startsWith('setbankroll ')) {
                ...
                // MESA TRACKER É MANTIDO INTACTO. O HARD RESET FOI REMOVIDO DAQUI.
                
                this.saveSystemState(); 
                this.generateNextTrade(); 
                
                console.clear();
                console.log(`\n \x1b[32m[!] HOT-SWAP SUCESSO: Banca ajustada para R$ ${newVal.toFixed(2)}. Histórico de VIX mantido 100% intacto.\x1b[0m`);
