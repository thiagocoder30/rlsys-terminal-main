...
echo "======================================"
echo " RL.SYS CORE - SPRINT 610"
echo " TITANIUM SHIELD & RIGOROUS THRESHOLDS"
echo "======================================"

ROOT_DIR=$(git rev-parse --show-toplevel 2>/dev/null || pwd)
cd "$ROOT_DIR/pwa-terminal"

# ARQUIVO INTEGRAL: src/core/useTacticalEngine.ts
...
echo "[RL.SYS] Compilação Concluída. Travas de Risco Restauradas para padrão CLI."
echo "======================================"
