...
echo "======================================"
echo " RL.SYS CORE - SPRINT 367"
echo " CALIBRATED SHANNON ENTROPY (VIX 95%)"
echo "======================================"

ROOT_DIR=$(git rev-parse --show-toplevel 2>/dev/null || pwd)
cd "$ROOT_DIR"

echo "[1/2] Salvando Integridade do Motor Contábel Polimórfico..."
...
echo "[2/2] Recompilando o Orquestrador com Calibragem de Trava a 95% de VIX..."
...
# Geração de commit tático exigida pelo controle do usuário
git add src/domain/financial/AutoSettlementEngine.js scripts/live-paper-orchestrator.js
git commit -m "fix(risk): recalibrate Shannon Entropy VIX threshold to 95% to align with legacy 42% dominance metrics (Sprint 367)" > /dev/null

echo "======================================"
echo -e "\033[1;32m SPRINT 367 INSTALADA COM SUCESSO \033[0m"
echo " STATUS: VIX CALIBRADO EM 95%"
echo "======================================"
