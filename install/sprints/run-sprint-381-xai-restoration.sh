...
echo "======================================"
echo " RL.SYS CORE - SPRINT 381"
echo " XAI RESTORATION & INPUT FIX (FULL REWRITE)"
echo "======================================"

ROOT_DIR=$(git rev-parse --show-toplevel 2>/dev/null || pwd)
cd "$ROOT_DIR"

echo "[1/2] Reescrevendo o Orquestrador para restaurar Auditoria e Escapes..."
...
echo "[2/2] Reconstruindo o commit no Git..."
git add src/presentation/cli/LivePaperOrchestrator.ts
git commit -m "fix(cli): restore missing XAI panels, correct VIEW_ONLY exit logic, and implement complete undo command structure (Sprint 381)" > /dev/null

echo "======================================"
echo -e "\033[1;32m SPRINT 381 INSTALADA COM SUCESSO \033[0m"
echo " STATUS: INTERFACE XAI 100% RESTAURADA"
echo "======================================"
