...
echo "======================================"
echo " RL.SYS CORE - SPRINT 372"
echo " CRYPTOGRAPHIC ANTI-TAMPER HARD LOCK"
echo "======================================"

ROOT_DIR=$(git rev-parse --show-toplevel 2>/dev/null || pwd)
cd "$ROOT_DIR"

echo "[1/3] Criando o Motor de Criptografia e Assinatura Digital (HMAC-SHA256)..."
mkdir -p src/infrastructure/persistence

cat > src/infrastructure/persistence/SecureBankrollRepository.js <<'EOF'
'use strict';
...
echo "[2/3] Integrando o Cofre Criptográfico ao Orquestrador..."
...
echo "[3/3] Registrando commit de segurança na árvore..."
git add src/infrastructure/persistence/SecureBankrollRepository.js scripts/live-paper-orchestrator.js
git commit -m "security(persistence): implement HMAC-SHA256 envelope to prevent manual bypass of Daily Hard Lock (Sprint 372)" > /dev/null

echo "======================================"
echo -e "\033[1;32m SPRINT 372 INSTALADA COM SUCESSO \033[0m"
echo " STATUS: COFRE CRIPTOGRÁFICO ATIVADO"
echo "======================================"
