...
echo "======================================"
echo " RL.SYS CORE - SPRINT 365"
echo " DUAL-THREAD TRIPLICATION (COLOR + PARITY)"
echo "======================================"

ROOT_DIR=$(git rev-parse --show-toplevel 2>/dev/null || pwd)
cd "$ROOT_DIR"

echo "[1/2] Adicionando Alvos de Paridade no Motor Contábil..."
...
echo "[2/2] Atualizando o Orquestrador para Dual-Thread (Cores + Paridades)..."
...
git commit -m "feat(analytics): expand Triplicacao engine to evaluate Colors and Parities in parallel (Sprint 365)" > /dev/null

echo "======================================"
echo -e "\033[1;32m SPRINT 365 INSTALADA COM SUCESSO \033[0m"
echo " STATUS: MOTOR DUAL-THREAD ONLINE"
echo "======================================"
