...
echo "======================================"
echo " RL.SYS CORE - HOTFIX 377.2"
echo " RISK & BUFFER MANAGEMENT (FULL REWRITE)"
echo "======================================"

ROOT_DIR=$(git rev-parse --show-toplevel 2>/dev/null || pwd)
cd "$ROOT_DIR"

echo "[1/2] Reescrevendo o Orquestrador CLI para acoplar Tolerância Dinâmica e Reset de Buffer..."
...
echo "[2/2] Registrando injeção completa de comandos de Tolerância e Reset..."
git add src/presentation/cli/LivePaperOrchestrator.ts
git commit -m "feat(cli): introduce buffer 'reset' command and 'risk low/normal' toggle commands with full persistence to manage operation in high-variance tables (Hotfix 377.2)" > /dev/null

echo "======================================"
echo -e "\033[1;32m HOTFIX 377.2 COMPILADO E INSTALADO \033[0m"
echo " STATUS: FERRAMENTAS DE DESBLOQUEIO E RISCO ATIVAS"
echo "======================================"
