...
echo "======================================"
echo " RL.SYS CORE - SPRINT 447"
echo " THE MAIN SWITCH (IGNITION HOOK)"
echo "======================================"

ROOT_DIR=$(git rev-parse --show-toplevel 2>/dev/null || pwd)
cd "$ROOT_DIR"

echo "[1/2] A reescrever o main.ts para invocar o LivePaperOrchestrator HFT..."
cat > src/main.ts <<'EOF'
...
echo "[2/2] A compilar o novo ponto de entrada..."
npx tsc

echo "======================================"
echo -e "\033[1;32m SPRINT 447 APLICADA COM SUCESSO \033[0m"
echo " STATUS: O MOTOR HFT ASSUMIU O CONTROLO"
echo "======================================"
