...
echo "======================================"
echo " RL.SYS CORE - SPRINT 380"
echo " TIMELINE UNDO (DYNAMIC CORRECTION)"
echo "======================================"

ROOT_DIR=$(git rev-parse --show-toplevel 2>/dev/null || pwd)
cd "$ROOT_DIR"

echo "[1/2] Injetando motor de deleção cronológica (Undo) no Orquestrador..."
...
echo "[2/2] Atualizando o Git com a mecânica de Undo..."
git add src/presentation/cli/LivePaperOrchestrator.ts
git commit -m "feat(cli): add 'undo' command to allow rapid correction of typo inputs and instant VIX recalculation (Sprint 380)" > /dev/null

echo "======================================"
echo -e "\033[1;32m SPRINT 380 INSTALADA COM SUCESSO \033[0m"
echo " STATUS: COMANDO UNDO OPERACIONAL"
echo "======================================"
