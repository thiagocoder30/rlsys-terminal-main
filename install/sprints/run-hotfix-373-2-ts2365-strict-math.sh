...
echo "======================================"
echo " RL.SYS CORE - HOTFIX 373.2"
echo " TS2365: STRICT MATH TYPE COMPARISON"
echo "======================================"

ROOT_DIR=$(git rev-parse --show-toplevel 2>/dev/null || pwd)
cd "$ROOT_DIR"

echo "[1/2] Reescrevendo a Camada de Apresentação (View) com Tipagem Rigorosa..."
...
echo "[2/2] Registrando commit do Hotfix na árvore..."
git add src/presentation/cli/LivePaperOrchestrator.ts
git commit -m "fix(cli): resolve TS2365 type mismatch by extracting raw numeric values prior to string formatting in report templates (Hotfix 373.2)" > /dev/null

echo "======================================"
echo -e "\033[1;32m HOTFIX 373.2 APLICADO COM SUCESSO \033[0m"
echo " STATUS: RESOLUÇÃO LÓGICA CONCLUÍDA"
echo "======================================"
