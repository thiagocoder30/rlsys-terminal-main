...
echo "======================================"
echo " RL.SYS CORE - SPRINT 382"
echo " SETBANKROLL FIX & GRANULAR TOGGLE UI"
echo "======================================"

ROOT_DIR=$(git rev-parse --show-toplevel 2>/dev/null || pwd)
cd "$ROOT_DIR"

echo "[1/2] Compilando Orquestrador Completo..."
...
echo "[2/2] Atualizando o Git com o suporte a Roteamento Granular..."
git add src/presentation/cli/LivePaperOrchestrator.ts
git commit -m "fix(cli): restore setbankroll command and update weights panel to expose exact strategy IDs for granular disable/enable control (Sprint 382)" > /dev/null

echo "======================================"
echo -e "\033[1;32m SPRINT 382 INSTALADA COM SUCESSO \033[0m"
echo " STATUS: SETBANKROLL ATIVO E CONTROLE GRANULAR UI EXPOSTO"
echo "======================================"
