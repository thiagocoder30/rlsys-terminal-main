...
export class LivePaperOrchestrator {
    ...
    private generateNextTrade(): void {
        ...
        // Atualiza a tradução textual XAI após processar o pipeline
        this.updateXaiTranslation(prospectiveId);
    }

    /**
     * Mapeador XAI: Transforma a matemática do HFT numa narrativa institucional legível.
     */
    ...
    private renderTerminalHud(): void {
        ...
        // FIX SPRINT 445: Ecrã XAI Traduzido
