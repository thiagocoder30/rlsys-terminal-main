...
echo "======================================"
echo " RL.SYS CORE - SPRINT 492"
echo " RESTAURAÇÃO INTEGRAL DO BACKTEST & EVENT LOOP"
echo "======================================"
...
export class LivePaperOrchestrator {
    ...
    private attachEventListeners(): void {
        this.rl.on('line', (line) => {
            ...
            if (this.systemLocked && lowerCmd !== 'stats' && lowerCmd !== 'journey' && lowerCmd !== 'weights' && !lowerCmd.startsWith('backtest') && lowerCmd !== 'exit' && lowerCmd !== 'quit') {
...
echo "[RL.SYS] Compilando Módulos Unificados e Restaurados..."
npx tsc || npm run build || true
echo "[RL.SYS] Sprint 492 Concluída com sucesso."
