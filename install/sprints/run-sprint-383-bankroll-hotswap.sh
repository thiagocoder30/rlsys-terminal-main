...
echo "======================================"
echo " RL.SYS CORE - SPRINT 383"
echo " BANKROLL HOT-SWAP (ISOLAMENTO DE DADOS)"
echo "======================================"

ROOT_DIR=$(git rev-parse --show-toplevel 2>/dev/null || pwd)
cd "$ROOT_DIR"

echo "[1/2] Separando motor financeiro do motor analítico (MesaTracker)..."
...
export class LivePaperOrchestrator {
    ...
    private attachEventListeners(): void {
        this.rl.on('line', (line) => {
            ...
            // ==========================================
            // FIX: SETBANKROLL HOT-SWAP (Não apaga mais a mesa)
            // ==========================================
            if (cmd.startsWith('setbankroll ')) {
                ...
                // Recalcula APENAS os motores financeiros, MANTENDO o this.mesaTracker e a linha do tempo intactos
                ...
                console.clear();
                console.log(`\n \x1b[32m[!] SUCESSO: Banca ajustada para R$ ${newVal.toFixed(2)}. Histórico da mesa e VIX mantidos intactos.\x1b[0m`);
...
echo "[2/2] Injetando correção na estrutura principal..."
git add src/presentation/cli/LivePaperOrchestrator.ts
git commit -m "fix(cli): correct setbankroll command to perform hot-swap of financial data without wiping analytics history (Sprint 382)" > /dev/null

echo "======================================"
echo -e "\033[1;32m SPRINT 382 INSTALADA COM SUCESSO \033[0m"
echo " STATUS: HOT-SWAP ATIVADO E CONTROLE GRANULAR ATUALIZADO"
echo "======================================"
