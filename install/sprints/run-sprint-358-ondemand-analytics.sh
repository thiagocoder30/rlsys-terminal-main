...
echo "======================================"
echo " RL.SYS CORE - SPRINT 358"
echo " ON-DEMAND ANALYTICS & CLEAN UI"
echo "======================================"

ROOT_DIR=$(git rev-parse --show-toplevel 2>/dev/null || pwd)
cd "$ROOT_DIR"

mkdir -p src/domain/analytics

echo "[1/2] Injetando Rastreamento Analítico (LiveMesaTracker)..."
...
echo "[2/2] Reconstruindo Orquestrador com Funcionalidades On-Demand..."
...
# Controle de Commits exigido pelo protocolo do usuário
git add src/domain/analytics/LiveMesaTracker.js scripts/live-paper-orchestrator.js
git commit -m "feat(analytics): implement on-demand timeline and heatmap visualization via specific commands (Sprint 358)" > /dev/null

echo "======================================"
echo -e "\033[1;32m SPRINT 358 INSTALADA COM SUCESSO \033[0m"
echo " STATUS: ON-DEMAND ANALYTICS ONLINE"
echo "======================================"
