...
echo "======================================"
echo " RL.SYS CORE - HOTFIX 374.1"
echo " UX: INTEGRATED HELP COMMAND MENU"
echo "======================================"

ROOT_DIR=$(git rev-parse --show-toplevel 2>/dev/null || pwd)
cd "$ROOT_DIR"

echo "[1/2] Injetando o Manual de Bordo no Orquestrador..."
...
echo "[2/2] Registrando injeção do comando Help na árvore Git..."
git add src/presentation/cli/LivePaperOrchestrator.ts
git commit -m "feat(cli): inject integrated help menu for quick operational reference (Hotfix 374.1)" > /dev/null

echo "======================================"
echo -e "\033[1;32m HOTFIX 374.1 APLICADO COM SUCESSO \033[0m"
echo " STATUS: MANUAL DE BORDO ONLINE"
echo "======================================"
