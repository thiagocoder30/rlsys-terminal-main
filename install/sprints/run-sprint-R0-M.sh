...
echo " RISK INTELLIGENCE LAYER (XAI & SCENARIO)"
echo "======================================"
...
export class LivePaperOrchestrator {
    ...
    private renderTerminalHud(): void {
        ...
        console.log(' RL.SYS CORE - TACTICAL ORCHESTRATOR [V5.11b]');
        console.log('\x1b[36m======================================================\x1b[0m');
    ...
    private attachEventListeners(): void {
        this.rl.on('line', (line) => {
            ...
            if (lowerCmd === 'help') {
                ...
                console.log('======================================================');
                console.log(' audit / why          : Painel XAI - Radiografia de Risco (NOVO)');
    ...
    private generateNextTrade() {
        ...
        if (this.currentVixPercent > this.dynamicVixTolerance) {
            ...
            if (this.activeStrategyId !== 'Nenhuma') {
                ...
                // NOVO: Filtro Estocástico contra Ruído (Stochastic Noise Filter)
                ...
                if (safeWeight < requiredWeight) {
                    ...
                    if (!sizing.isSafe) {
                        ...
                        // NOVO: Cálculo de Impacto Pós-Giro (Pre-Spin Impact)
                        let winProfit = 0;
                        if (this.activeStrategyId.startsWith('CROSS_GRID')) winProfit = (3 * minChip * sizing.multiplier) - sizing.total;
                        else if (this.activeStrategyId.startsWith('SECTOR_') || this.activeStrategyId === 'FUSION_REDUZIDA') winProfit = (36 * minChip * sizing.multiplier) - sizing.total;
...
echo "[RL.SYS] Compilando Risk Intelligence Layer..."
npx tsc || npm run build || true
echo "[RL.SYS] Sprint R0-M Concluída."
