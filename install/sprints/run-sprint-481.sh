...
echo "======================================"
echo " RL.SYS CORE - SPRINT 481"
echo " GOVERNANÇA TOTAL E AVALIADOR IMPLACÁVEL"
echo "======================================"
...
echo "[RL.SYS] Compilando Governança e Matriz de Desempate..."
npx tsc || npm run build || true
echo "[RL.SYS] Sprint 481 Concluída. Todos os comandos operacionais."
