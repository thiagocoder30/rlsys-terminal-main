...
echo "======================================"
echo " RL.SYS CORE - SPRINT 456"
echo " ARCHITECTURAL SNAPSHOT GENERATOR"
echo "======================================"

ROOT_DIR=$(git rev-parse --show-toplevel 2>/dev/null || pwd)
cd "$ROOT_DIR"

OUTPUT_FILE="data/RLSYS-SESSION-SNAPSHOT.md"
mkdir -p data

echo "[1/2] Compilando informações do ecossistema e gerando Dossiê..."
...
echo -e "[2/2] \x1b[32mDossiê técnico gerado com sucesso em: $OUTPUT_FILE\x1b[0m"

echo "[+] Registrando a Sprint de persistência de contexto no repositório..."
