...
echo "======================================"
echo " RL.SYS CORE - HOTFIX 375.3"
echo " FULL RAM STATE PERSISTENCE (HISTORY & COOLDOWN)"
echo "======================================"

ROOT_DIR=$(git rev-parse --show-toplevel 2>/dev/null || pwd)
cd "$ROOT_DIR"

echo "[1/2] Modificando Orquestrador para persistir Histórico e Travas Temporárias..."
...
echo "[2/2] Atualizando o Cofre e registrando alteração no repositório..."
git add src/presentation/cli/LivePaperOrchestrator.ts
git commit -m "fix(persistence): inject LiveMesaTracker history and 15-minute Toxic Cooldown lock into cryptographic JSON envelope to ensure full RAM state continuity across CLI restarts (Hotfix 375.3)" > /dev/null

echo "======================================"
echo -e "\033[1;32m HOTFIX 375.3 APLICADO COM SUCESSO \033[0m"
echo " STATUS: PERSISTÊNCIA DE MEMÓRIA (RAM) ATIVADA"
echo "======================================"
