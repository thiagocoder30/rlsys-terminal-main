...
echo "======================================"
echo " RL.SYS CORE - HOTFIX 375.5"
echo " CONTINUOUS VIX ENGINE (DECOUPLED XAI)"
echo "======================================"

ROOT_DIR=$(git rev-parse --show-toplevel 2>/dev/null || pwd)
cd "$ROOT_DIR"

echo "[1/2] Desacoplando Leitura de Entropia das Travas de Execução..."
...
echo "[2/2] Registrando correção contínua no Cofre Criptográfico..."
git add src/presentation/cli/LivePaperOrchestrator.ts
git commit -m "fix(risk): decouple Shannon Entropy (VIX) engine from execution guardrails to prevent 0.0% visual anomaly during Cooldown states (Hotfix 375.5)" > /dev/null

echo "======================================"
echo -e "\033[1;32m HOTFIX 375.5 APLICADO COM SUCESSO \033[0m"
echo " STATUS: MOTOR XAI DESACOPLADO E CONTÍNUO"
echo "======================================"
