...
echo "======================================"
echo " RL.SYS CORE - SPRINT 459-F"
echo " BANKROLL HOT-SWAP (HOTFIX)"
echo "======================================"

ROOT_DIR=$(git rev-parse --show-toplevel 2>/dev/null || pwd)
cd "$ROOT_DIR"

echo "[1/2] Compilando Orquestrador com injeção financeira..."
...
export class LivePaperOrchestrator {
    ...
    private attachEventListeners(): void {
        this.rl.on('line', (line) => {
            ...
            // COMANDO SETBANKROLL (INJEÇÃO DE CAPITAL A QUENTE)
            if (cmd.startsWith('setbankroll ')) {
                ...
                if (!isNaN(newVal) && newVal >= 0) {
                    ...
                    this.lastActionTakenText = `\x1b[32m[SISTEMA] Banca recalibrada para R$ ${newVal.toFixed(2)}. Timeline mantida.\x1b[0m`;
                    this.renderTerminalHud();
                } else {
                    this.lastActionTakenText = `\x1b[31m[ERRO] Valor inválido para banca.\x1b[0m`;
                    this.renderTerminalHud();
                }
                return;
            }
            ...
            if (cmd === 'help') {
                ...
                console.log('======================================================');
                console.log(' setbankroll <valor>  : Ajusta banca (Mantém Timeline e Entropia)');
    ...
    private renderTerminalHud(): void {
        console.clear();
        console.log('======================================================');
        console.log(' 🛡️  RL.SYS CORE - TACTICAL ORCHESTRATOR [V5.0]');
        console.log('======================================================');
...
echo "[2/2] Compilando motor financeiro flexivel..."
npx tsc

echo "======================================"
echo -e "\033[1;32m SPRINT 459-F APLICADA COM SUCESSO \033[0m"
echo " STATUS: BANKROLL HOT-SWAP ATIVADO"
echo "======================================"
