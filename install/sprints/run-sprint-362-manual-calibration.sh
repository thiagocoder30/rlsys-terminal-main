...
echo "======================================"
echo " RL.SYS CORE - SPRINT 362"
echo " MANUAL BANKROLL CALIBRATION ENGINE"
echo "======================================"

ROOT_DIR=$(git rev-parse --show-toplevel 2>/dev/null || pwd)
cd "$ROOT_DIR"

echo "[1/1] Atualizando Orquestrador Principal com Comando Administrativo..."
...
# Cumprimento rigoroso das políticas de commits da governança do usuário
git add scripts/live-paper-orchestrator.js
git commit -m "feat(financial): add administrative command setbankroll to clear simulation state and set real balances (Sprint 362)" > /dev/null

echo "======================================"
echo -e "\033[1;32m SPRINT 362 INSTALADA COM SUCESSO \033[0m"
echo " STATUS: RESET ADMINISTRATIVO DE BANCA ONLINE"
echo "======================================"
