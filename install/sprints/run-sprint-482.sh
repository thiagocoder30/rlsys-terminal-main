...
echo "======================================"
echo " RL.SYS CORE - SPRINT 482"
echo " TRAILING STOP LOSS & ALVOS DINÂMICOS"
echo "======================================"
...
echo "[RL.SYS] Compilando lógica dinâmica de Stop Móvel..."
npx tsc || npm run build || true
echo "[RL.SYS] Sprint 482 Concluída."
