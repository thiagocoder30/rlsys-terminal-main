...
PATCH="rlsys-terminal-sprint-034-runtime-enforcement-orchestrator-v2.diff"
BRANCH="sprint-034-runtime-enforcement-orchestrator"
LOG_DIR="$PROJECT_DIR/logs"
RUN_LOG="$LOG_DIR/sprint-034-v2-install-$(date +%Y%m%d-%H%M%S).log"
...
echo "[SUCESSO] Sprint 034 v2 instalada com sucesso."
