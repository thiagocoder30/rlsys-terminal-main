const fs = require('fs');
let content = fs.readFileSync('src/application/session-startup/StartupValidator.ts', 'utf8');

content = `import { StartupProgress } from './StartupProgress';
...
fs.writeFileSync('src/application/session-startup/StartupValidator.ts', content);
